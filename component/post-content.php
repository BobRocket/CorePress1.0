    ...
    <div class="post-content-post">
        ...
        <div class="post-end-tools">
            ...
            <script>
                ...
                var clipboard = new ClipboardJS('.code-bar-btm-copy', {
        ...
        <div class="post-tool-plane">
          ...
          global $corepress_post_meta;
            ...
            if ($corepress_post_meta['catalog'] == 1) {
                ?>
                <div id="post-catalog">
                    <div class="post-catalog-main">
                        <div class="catalog-title">文章目录</div>
                        <div id="post-catalog-list">
                        </div>
                        <div class="catalog-close" onclick="close_show(0)">收起</div>
                    </div>
                    <div id="post-catalog-closebtn" class="post-catalog-closebtn-hide" title="目录" onclick="close_show(1)">
